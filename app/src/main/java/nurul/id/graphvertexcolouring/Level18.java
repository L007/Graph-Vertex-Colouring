...
public class Level18 extends AppCompatActivity {
    ...
    int warnaVertex1 = 1, warnaVertex2 = 1,
            ...
            warnaVertex5 = 1, warnaVertex6 = 1, warnaVertex7=1,warnaVertex8=1,warnaVertex9=1,warnaVertex10=1,warnaVertex11=1, counter = 20000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Level 18");
...
//                    onBackPressed();
                    Intent i = new Intent(Level18.this, MainActivity.class);
                    startActivity(i);
                    finish();
                }
            });
    ...
    private void nextDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Level18.this);
        ...
        dialogButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Level18.this,Level19.class);
                startActivity(i);
            }
        });
    ...
    private void retryDialog() {
        ...
        dialogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.commit();
                Intent i = new Intent(Level18.this, Level18.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void ubahStatus() {
        ...
        editor.putBoolean("status_" + 18, true);
        editor.putBoolean("level_" + 19, true);
