...
public class Level13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Level 13");
...
//                    onBackPressed();
                    Intent i = new Intent(Level13.this, MainActivity.class);
                    startActivity(i);
                    finish();
                }
            });
    ...
    private void nextDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(Level13.this);
        ...
        dialogButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Level13.this,Level14.class);
                startActivity(i);
            }
        });
    ...
    private void timeoutDialog() {
        ...
        dialogButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Level13.this, Level13.class);
                startActivity(i);
            }
        });
        builder.setView(view);
    ...
    private void ubahStatus() {
        ...
        editor.putBoolean("status_" + 13, true);
        editor.putBoolean("level_" + 14, true);
