...
public class Level15 extends AppCompatActivity {
    ...
    int warnaVertex1 = 1, warnaVertex2 = 1,
            ...
            warnaVertex5 = 1, warnaVertex6 = 1, warnaVertex7=1,warnaVertex8=1, counter = 15000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Level 15");
...
//                    onBackPressed();
                    Intent i = new Intent(Level15.this, MainActivity.class);
                    startActivity(i);
                    finish();
                }
            });
    ...
    private void nextDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Level15.this);
        ...
        dialogButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Level15.this,Level16.class);
                startActivity(i);
            }
        });
    ...
    private void retryDialog() {
        ...
        dialogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.commit();
                Intent i = new Intent(Level15.this, Level15.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void ubahStatus() {
        ...
        editor.putBoolean("status_" + 15, true);
        editor.putBoolean("level_" + 16, true);
