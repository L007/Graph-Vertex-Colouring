 ...
 */
public class C6Fragment extends Fragment {
    ...
    String warnaVertex1 = "kuning", warnaVertex2 = "kuning",
            ...
            warnaVertex5 = "kuning", warnaVertex6 = "kuning";
    TextView txtClick, txtStatus, txtClickLeft;
    int click = 3, jumlahClickV1, jumlahClickV2, jumlahClickV3, jumlahClickV4,jumlahClickV5, jumlahClickV6;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vertex6 = (ImageButton) view.findViewById(R.id.Vertex6);
        ...
        vertex6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (click > 0) {
                    jumlahClickV6++;
                    if (jumlahClickV6 % 2 == 1) {
                        if (jumlahClickV6 % 3 == 0) {
                            vertex6.setBackgroundResource(R.drawable.yellow);
                            warnaVertex6 = "kuning";
                        } else {
                            vertex6.setBackgroundResource(R.drawable.blue);
                            warnaVertex6 = "biru";
                        }

                    } else if (jumlahClickV6 % 2 == 0) {
                        if (jumlahClickV6 % 3 == 0) {
                            vertex6.setBackgroundResource(R.drawable.yellow);
                            warnaVertex6 = "kuning";
                        } else {
                            vertex6.setBackgroundResource(R.drawable.red);
                            warnaVertex6 = "merah";
                        }
        ...
        if (click == 0) {
            ...
            if ((
                    warnaVertex1.equalsIgnoreCase("kuning") &&
                            ...
                            warnaVertex6.equalsIgnoreCase("biru")
            ) ||
                    (
                            warnaVertex1.equalsIgnoreCase("biru") &&
                                    ...
                                    warnaVertex6.equalsIgnoreCase("kuning")
                    )
                    ){
