...
public class Level11 extends AppCompatActivity {
    ...
    ImageButton vertex1, vertex2, vertex3, vertex4, vertex5, vertex6, vertex7,vertex8,vertex9,vertex10,vertex11,vertex12;
    int warnaVertex1 = 1, warnaVertex2 = 1,
            ...
            warnaVertex11=1,warnaVertex12=1, counter = 15000;
    ...
    int click = 4, jumlahClickV1 = 1, jumlahClickV2 = 1, jumlahClickV3 = 1, jumlahClickV4 = 1,
            ...
            ,jumlahClickV10=1,jumlahClickV11=1,jumlahClickV12=1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Level 11");
...
//                    onBackPressed();
                    Intent i = new Intent(Level11.this, MainActivity.class);
                    startActivity(i);
                    finish();
                }
            });
    ...
    private void nextDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(Level11.this);
        ...
        dialogButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Level11.this,Level12.class);
                startActivity(i);
            }
        });
    ...
    private void retryDialog() {
        ...
        dialogButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Level11.this, Level11.class);
                startActivity(i);
            }
        });
        builder.setView(view);
    ...
    private void ubahStatus() {
        ...
        editor.putBoolean("status_" + 11, true);
        editor.putBoolean("level_" + 12, true);
