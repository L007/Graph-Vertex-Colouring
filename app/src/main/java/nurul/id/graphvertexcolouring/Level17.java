...
public class Level17 extends AppCompatActivity {
    ...
    int warnaVertex1 = 1, warnaVertex2 = 1,
            ...
            warnaVertex11=1,warnaVertex12=1, counter = 20000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Level 17");
...
//                    onBackPressed();
                    Intent i = new Intent(Level17.this, MainActivity.class);
                    startActivity(i);
                    finish();
                }
            });
    ...
    private void nextDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Level17.this);
        ...
        dialogButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Level17.this,Level18.class);
                startActivity(i);
            }
        });
    ...
    private void retryDialog() {
        ...
        dialogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.commit();
                Intent i = new Intent(Level17.this, Level17.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void ubahStatus() {
        ...
        editor.putBoolean("status_" + 17, true);
        editor.putBoolean("level_" + 18, true);
